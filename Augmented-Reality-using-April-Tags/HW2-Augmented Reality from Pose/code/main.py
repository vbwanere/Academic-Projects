...
if __name__ == "__main__":
    ...
    if args.click_points:
        ...
        frame = iio.imread("V:/Python/pythonProject/CIS 5800/HW-2/hw2_release/data/frames/frame0000.jpg")
    ...
    frames = glob.glob('V:/Python/pythonProject/CIS 5800/HW-2/hw2_release/data/frames/*.jpg')
    frames.sort()
    images = [np.array(iio.imread(f)) for f in frames]

    # extrinsic
    corners = np.load('V:/Python/pythonProject/CIS 5800/HW-2/hw2_release/data/corners.npy')
    ...
    drill_mesh = trimesh.load("V:/Python/pythonProject/CIS 5800/HW-2/hw2_release/data/models/drill.obj")
    fuze_mesh = trimesh.load("V:/Python/pythonProject/CIS 5800/HW-2/hw2_release/data/models/fuze.obj")
