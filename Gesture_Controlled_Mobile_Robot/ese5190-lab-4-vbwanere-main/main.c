...
int main(void) {
    ...
    while (1) {
        ...
        if(computer_reached == 0){
            LCD_drawBlock(153, computer_paddle_starts, 159, computer_paddle_ends, BLUE);
            LCD_drawBlock(153, computer_paddle_starts, 159, computer_paddle_ends, WHITE);
        ...
        // bouncing ball:
        LCD_drawCircle(ball_x0, ball_y0, 5, RED);
        LCD_drawCircle(ball_x0, ball_y0, 5, WHITE);
